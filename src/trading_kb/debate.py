...
材料含【情绪面·不同观点(C级)】段时，可引用其中的 C 级情绪面/前瞻观点作为短期催化或情绪支撑，注明"(C级·待验证)"——情绪影响短期价格，别因成色低就整体略过。
...
2) 补充 2-3 条独立看空论点。
只用材料中的信息，不编造。材料含【情绪面·不同观点(C级)】段时，也可引用其中的 C 级看空/分歧观点(注明"(C级·待验证)")作为独立看空视角。
...
- 净判断：方向 + 关键风险 + 该跟踪的验证点；
- 成色(可靠性)与时效(对当下决策相关性)分开判断：老的高成色若口径已被时间淘汰则权重下调；新的低成色若对当下有实质影响应作"当前主导变量"积极纳入并标"待交叉验证"；只有"低成色且已被反证或无独立佐证"的孤证才不得作为独立买点；
- 净判断须纳入【情绪面·不同观点(C级)】里的 C 级情绪/分歧观点作为"短期情绪面/分歧视角"、逐条标注"(C级·待验证)"：情绪与分歧本身影响短期价格、也提供对立视角，别因成色低就整体略过——但明确与高成色的中长期判断分开表述。
